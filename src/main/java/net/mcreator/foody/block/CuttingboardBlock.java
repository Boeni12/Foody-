...
package net.mcreator.foody.block;
...
import net.mcreator.foody.gui.CuttingboardGUIGui;
...
public class CuttingboardBlock extends FoodyElements.ModElement {
	@ObjectHolder("foody:cuttingboard")
	public static final Block block = null;
	public CuttingboardBlock(FoodyElements instance) {
		super(instance, 10);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Cutting Board");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new CuttingboardGUIGui.GuiContainerMod(id, inventory,
