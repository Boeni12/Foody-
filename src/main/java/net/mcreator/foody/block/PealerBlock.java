...
import net.mcreator.foody.gui.PealerGUIGui;
...
public class PealerBlock extends FoodyElements.ModElement {
	@ObjectHolder("foody:pealer")
	public static final Block block = null;
	public PealerBlock(FoodyElements instance) {
		super(instance, 5);
	}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Pealer");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new PealerGUIGui.GuiContainerMod(id, inventory,
